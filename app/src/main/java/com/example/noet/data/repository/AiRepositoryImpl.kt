...
class AiRepositoryImpl @Inject constructor(
    ...
    override suspend fun translateAndGenerate(word: String, categories: List<String> ): AiResponse? {
    ...
    override suspend fun translateParagraphWithImage(bitmap: Bitmap, categories: List<String>): AiImageResponse? {
        val categoryListString = categories.joinToString(", ")
        val prompt = """
    ...
    override suspend fun generatePicture(
    ...
    override suspend fun generateMusicSong(
        vocabularies: List<Vocabulary>
    ): AiMusicResponse? {
